...
export default function AnimatedBackground() {
  ...
  return (
    <View className="absolute top-0 bottom-0 left-0 right-0 items-center">
      {/* circles */}
      <Animated.View
        className="absolute w-[400%] aspect-square rounded-full bg-sky-400 "
        style={{ top: top1 }}
      />
      <Animated.View
        className="absolute w-[400%] aspect-square rounded-full bg-sky-500"
        style={{ top: top2 }}
      />
      <Animated.View
        className="absolute w-[400%] aspect-square rounded-full bg-sky-600 "
        style={{ top: top3 }}
      />
    </View>
  );
